...
const BAN =
  ...
  "no therapy couch, no bus, no train, no airplane, no airport, no public transport of any kind, no service-dog vest, " +
  "no labeled harness, no uniformed official. " +
  US_CAST;
...
export const VIDEOS = [
  { id:"d1-viewing", title:"Thirty Seconds",
    prompt:
      "A fifteen-second vertical video about a woman viewing an apartment with her dog. "+
      ...
      "BEATS. 0.0-3.0s parked car outside an apartment building, phone selfie, the spaniel sitting up in the passenger seat "+
  ...
  { id:"d2-lobby", title:"I Used To Dread That",
    prompt:
      ...
      "OPTICS: phone camera, handheld from behind him then beside him, bright indoor daylight, natural color. "+
      ...
      "desk looks over. CONCIERGE: \"Excuse me, sir. Is he yours?\" "+
      ...
      "look at the puppy properly. CONCIERGE: \"Oh, no problem at all. He's gorgeous.\" "+
      "8.0-12.0s inside the elevator, the doors closing, phone held low. The man speaks quietly, half to the dog. "+
      ...
      "chest with both hands as the elevator doors close on them. "+
      WHOLESOME + " AUDIO: diegetic only, lobby echo, claws on tile, an elevator chime. No music. "+
      CARD_RULE + " " + SPEECH + " " + BAN },

  { id:"d3-bench", title:"Explaining",
    prompt:
      "A fifteen-second vertical video of an older woman on a park bench with her small dog. "+
      "OPTICS: phone camera, handheld, low golden late-afternoon sun, warm natural color, soft grain. "+
  ...
  { id:"d4-section-four", title:"Section Four",
    prompt:
      ...
      "OPTICS: phone propped against a mug so the frame tilts very slightly, bright morning kitchen light, natural color. "+
  ...
  { id:"d5-hotel", title:"The Weekend",
    prompt:
      ...
      "OPTICS: phone camera, handheld, bright afternoon daylight then warm interior light, natural color. "+
      "ANIMAL: a cocker spaniel puppy with long wavy ears and enormous paws, tripping over its own feet. "+
      "BEATS. 0.0-3.0s an open trunk outside a small hotel, a bag coming out, the puppy jumping down and immediately "+
      ...
      WHOLESOME + " AUDIO: diegetic only, a trunk closing, reception room tone, bedsprings, puppy snuffling. No music. "+
      CARD_RULE + " " + SPEECH + " " + BAN },
];
