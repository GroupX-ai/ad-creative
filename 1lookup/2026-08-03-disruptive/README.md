...
**One defect did get through the first pass and forced a full re-roll: the wordmark.** 18 of the 19 files rendered `1Lookup` with a capital L. The site header lockup is lowercase, a blue `1` then `lookup` with a lowercase l (`src/components/navigation/header.tsx:782-789`). It was easy to wave off because the prose brand name genuinely is "1Lookup" everywhere else, in the footer copyright, the page titles and the OG tags, and the first review did wave it off on exactly that evidence. That was the wrong source: for a wordmark, the component that renders the logo is the authority, not the metadata. Fixed by adding an explicit lowercase instruction to every prompt, proven on a single test render first, then re-rolled across all 18. `c13` was kept from the first pass because it had already rendered lowercase.

Three files carry notes:

- **`1lookup-c3-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c3-vertical.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c4-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c4-landscape.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c5-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c5-vertical.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c6-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c6-landscape.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c7-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c7-vertical.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c8-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c8-landscape.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c9-square.png`** — The 3D 300ms is near-black on black and may mud at 300px. The landscape cut states 300ms in flat white as well and is the safer buy for small placements. Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c9-landscape.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c10-square.png`** — Renders commented-out placeholder env var names. No fabricated stat or third-party brand; the five categories map exactly to the approved "validation, enrichment, B2B prospecting, SEO and transcription" line. Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c11-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c12-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
- **`1lookup-c13-square.png`** — Renders a real API endpoint (api.1lookup.io/v1/validate/email/bulk), verified against src/components/home/live-ledger.tsx:202 and four live code samples. Deliberate exception to the no-other-text rule: it is the concept, and it is true. Kept from the first render pass: its wordmark was already lowercase.
- **`1lookup-c14-square.png`** — Re-rolled 2026-08-03 with an explicit lowercase-wordmark instruction after the first pass rendered "1Lookup" with a capital L; re-verified at full size.
