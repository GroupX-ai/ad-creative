...
export const ADS = [
  // -------------------------------------------------------------------------
  {
    id: "1capture-platform-b14v01-fourth-free-trial",
    company: "1capture",
    title: "Fourth Free Trial",
    ...
    prompt: [
      ...
      `BEATS.`,
      `0-2s: He is already talking, mid-gesture, leaning in, loud and fast: "Same card, fourth trial. Same guy."`,
      `2-5s: He sits back, one hand up, still going: "I caught it when he tried to pay."`,
      `5-10s: He keeps talking straight into the lens, quieter now, explaining rather than complaining, one hand flat on the table: "Now every trial starts with a real card check." He finishes that sentence inside the first three seconds of this window, then holds completely still and silent for the rest of it, breathing and looking into the lens, saying nothing at all.`,
      `10-12.6s: He stops moving completely and says it plainly, as a general figure about the category, the way a person quotes something they read rather than a result he is claiming for his own company: "Two to three times is typical."`,
      `12.6-15s: Still, level, unhurried, looking straight into the lens: "Start free. It's free under ten K."`,
      SAY_SIGNUP,
  ...
  // -------------------------------------------------------------------------
  {
    id: "1capture-platform-b14v02-ten-signups",
    company: "1capture",
    title: "Ten Signups",
    ...
    prompt: [
      ...
      `BEATS.`,
      `0-2s: She is already speaking, looking straight into the lens, flat and even: "My last ten signups. Two paid."`,
      `2-5s: One small shrug, no change in tone: "The other eight were never buying."`,
      `5-9.8s: She keeps looking into the lens, still level, explaining it once: "So now the card comes first, before the trial starts." After the line she is silent for the whole rest of this beat, motionless, one slow breath, still holding the phone and still looking into the lens, and she says no other word until the next written line begins.`,
      `9.8-12.4s: She stops entirely and says it as a plain fact about another company, no emphasis: "VoiceDrop hit fifty-seven percent."`,
      `12.4-15s: Level, unhurried, eye contact locked into the lens: "Start free. It's free under ten K."`,
  ...
  // -------------------------------------------------------------------------
  {
    id: "1capture-platform-b14v03-a-real-card",
    company: "1capture",
    title: "A Real Card",
    ...
    prompt: [
      ...
      `BEATS.`,
      `0-2s: She is already talking into the lens, quick and light: "A real card. Every signup."`,
      `2-5s: A flick of the eyebrows, quoting somebody, then a short huff through the nose: "They warned me it would kill signups."`,
      `5-9.8s: Straight into the lens, plainly, in her own unhurried voice, explaining it once: "It killed the window-shoppers. Real customers verify a card." After the line she is silent for the rest of this beat, still, one slow breath, still looking into the lens, and she says no other word until the next written line begins.`,
      `9.8-12.2s: She stops and says it as a plain fact, no emphasis added: "A hundred plus SaaS teams trust it."`,
      `12.2-15s: Level, unhurried, eye contact locked into the lens: "Start free. It's free under ten K."`,
